...
<main class="content">
        ...
        <div class="card flex-fill container">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="h3 col-sm-8"><strong>Rejected Reservation</strong></h1>
                    <a href="{{ route('reservation.my-reservations') }}" class="btn btn-info btn-sm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Disabled input" value="{{ $reservation->start_time }}" disabled>
                    <br>

                    <label class="form-label">End Time</label>
                    <input type="text" class="form-control" placeholder="Disabled input" value="{{ $reservation->end_time }}" disabled>
                    <br>

                    <label class="form-label">Venue</label>
                    <input type="text" class="form-control" value="{{$reservation->venue->venue_code}} - {{$reservation->venue->VenueType->title}}" disabled>
                    <br>
    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="h3 col-sm-8"><strong>Update Reservation</strong></h1>
        </div>
        <div class="mb-3">
                    @if($errors->any())
